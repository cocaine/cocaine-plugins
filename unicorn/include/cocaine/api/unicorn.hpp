...
public:
     ...
     * Actual result types are specified in rpotocol idl (include/cocaine/idl/unicorn.hpp).
     **/
    struct response {
        typedef result_of<io::unicorn::put>::type put;
        typedef result_of<io::unicorn::create>::type create;
        typedef result_of<io::unicorn::del>::type del;
        typedef result_of<io::unicorn::increment>::type increment;
        typedef result_of<io::unicorn::get>::type get;
        typedef result_of<io::unicorn::subscribe>::type subscribe;
        typedef result_of<io::unicorn::children_subscribe>::type children_subscribe;
        typedef result_of<io::unicorn::lock>::type lock;
    };
